...
//   // Handle navigation to order page
//   const handleViewOrderClick = () => {
//     navigate('/order'); // Replace '/order-page' with your actual order page route
//   };
...
//         takeawayTime,
//         address,
//         // Email is optional, so we include it only if it exists
//         ...(email && { email })
//       };
...
//           ...data,
//           selectedOption: undefined, // Not needed for takeaway
//           selectedDate: undefined, // Not needed for takeaway
//           selectedTimes: undefined, // Not needed for takeaway
//           address: undefined // Not needed for takeaway
//         });
//       } else if (orderType === 'Table Booking') {
//         await axios.post('http://localhost:3001/api/orders', data);
//       } else if (orderType === 'Home Delivery') {
//         await axios.post('http://localhost:3001/api/orders', {
//           ...data,
//           selectedOption: undefined, // Not needed for home delivery
//           selectedDate: undefined, // Not needed for home delivery
//           selectedTimes: undefined, // Not needed for home delivery
//           takeawayTime: undefined // Not needed for home delivery
//         });
//       }
...
//   // Handle navigation to order page
//   const handleViewOrderClick = () => {
//     navigate('/order'); // Replace '/order' with your actual order page route
//   };
    ...
    try {
      ...
      if (orderType === 'Takeaway') {
        ...
        await axios.post('http://localhost:3001/api/orders', {
          ...
          selectedDate: undefined,
          selectedTimes: undefined,
          takeawayTime: undefined
        });
      }

      // Send history data to the history API
